...
export function AllMoods({ onChange }) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, "Karen's Mood"),
        React.createElement("select", { name: "moods", id: "moods", onChange: (e) => onChange(e.target.value), className: "w-full p-2 border border-gray-300 rounded-md focus:ring-rose-500 focus:border-rose-500" },
            React.createElement("option", null, "Select a mood"),
